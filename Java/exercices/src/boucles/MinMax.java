...
public class MinMax {
    ...
    public static void main(String[] args) {
        //Ecrire le programme qui lit une série de nombres (la série est terminée lorsque l’on tape 0). Afficher 
        //le plus grand nombre lu ainsi que le nombre de fois que ce nombre a été tapé. Idem avec le plus 
        //petit.
